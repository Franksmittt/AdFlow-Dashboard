...
const BudgetEditorModal = ({ isOpen, onClose, onSave, budgetToEdit, isSaving }) => { // Receive isSaving prop
...
export default function BudgetClientView({ initialBudgets }) {
    ...
    const handleDeleteClick = async (id) => { 
        // In a real app, you would replace this with a custom, non-blocking confirmation modal.
